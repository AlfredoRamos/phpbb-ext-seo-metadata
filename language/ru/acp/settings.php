...
$lang = array_merge($lang, [
	'ACP_SEO_METADATA_EXPLAIN' => '<p>Здесь вы можете настроить метаданные, которые вы хотите генерировать и отображать. Ознакомьтесь с <a href="%1$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>Часто задаваемые вопросы</strong></a> для получения дополнительной информации. Если вам нужна помощь, посетите раздел <a href="%2$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>Поддержка</strong></a>.</p>',
