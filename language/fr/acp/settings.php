...
$lang = array_merge($lang, [
	'ACP_SEO_METADATA_EXPLAIN' => '<p>Vous pouvez configurer, ici, le contenu des balises meta que vous voulez générer et afficher. Consultez la page <a href="%1$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>FAQ</strong></a> pour plus d\'informations. Si vous avez besoin d\'aide, veuillez visiter la section <a href="%2$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>Support</strong></a>.</p><p>Si vous appréciez cette extension ou si vous l\'avez trouvée utile, et que vous souhaitez témoigner votre reconnaissance, vous pouvez soutenir son développement <a href="%3$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>en faisant un don</strong></a>.</p>',
