...
$lang = array_merge($lang, [
	...
	'ACP_SEO_METADATA_EXPLAIN' => 'Changes the following values will only be applied to new topics, if you want it to be applied to old topics too, you will need to purge the cache.',
