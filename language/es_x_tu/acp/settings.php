...
$lang = array_merge($lang, [
	'ACP_SEO_METADATA_EXPLAIN' => '<p>Aquí puedes configurar los meta datos que desees generar y mostrar. Consulta las <a href="%1$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>Preguntas Frecuentes</strong></a> para obtener más información. Si requieres de ayuda, por favor visita la sección de <a href="%2$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>Soporte</strong></a>.</p><p>Si te gusta o te resultó útil esta extension y quisieras mostrar tu agradecimiento, podrías considerar apoyar el desarrollo <a href="%3$s" rel="external nofollow noreferrer noopener" target="_blank"><strong>haciendo una donación</strong></a>.</p>',
